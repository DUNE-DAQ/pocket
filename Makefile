...
.PHONY: ers2kafka.local
ers2kafka.local: kafka.local erspostgres.local 
	@echo "installing ers2kafka"
...
.PHONY: ers.local
ers.local: kafka.local erspostgres.local ers2kafka.local grafana.local
	@echo "installing ers"
